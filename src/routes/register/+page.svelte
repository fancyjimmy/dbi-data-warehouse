...
<div class="flex overflow-hidden w-full h-full divide-x-2 divide-black">
	...
	>
		<div class="w-full max-w-xl mx-auto lg:w-96">
			<div>
				<h2 class="mt-6 text-3xl font-heading text-secondary-500">Register.</h2>
			</div>
			...
			<div class="mt-8">
				<form class="flex flex-col gap-3" on:submit|preventDefault={() => handleSignUp()}>
					...
					<div class="flex items-center justify-between">
						<div>
							<a href="/login" class="font-body text-primary-600 hover:text-primary-500">
								Log in?
							</a>
						</div>
					</div>
					...
					<button
						type="submit"
						class=" px-10 py-4 text-base font-medium text-center text-white border-3d bg-primary-500 hover:bg-primary-600 disabled:saturate-0"
						>Registrieren</button
					>
				</form>
			</div>
